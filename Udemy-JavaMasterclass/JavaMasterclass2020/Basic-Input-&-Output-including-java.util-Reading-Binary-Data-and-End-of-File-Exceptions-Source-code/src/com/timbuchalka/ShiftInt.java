...
public class ShiftInt {
    ...
    public static void main(String[] args) {
        int x = 0b01011010111011101010101011101001;
    ...
    private static void display(int x) {
        ...
        int y = x & 0xFF;
        String output = String.format("%32s and 0xFF is %8s \t %10d is ",  Integer.toBinaryString(x), Integer.toBinaryString(y), x) + colouredBinary;
